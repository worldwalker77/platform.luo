...
public class GameController {
	...
	@ResponseBody
	public Result login(String userId, String code, String deviceType, HttpServletResponse response, HttpServletRequest request){
		response.addHeader("Access-Control-Allow-Origin", "*");
		Result result = null;
		try {
			result = commonGameService.login1(userId, code, deviceType, request);
		} catch (Exception e) {
